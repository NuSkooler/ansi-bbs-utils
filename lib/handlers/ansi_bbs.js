...
//  The 3/4-bit palette, in SGR order (30..37 / 40..47)
...
module.exports = class ANSI_BBS extends Handler {
    constructor(terminal) {
        ...
        //  red(), redBG(), ... shortcuts; each is sgr() with the name
        ColorNames.forEach(color => {
            this[color] = (...args) => this.sgr(color, ...args);
            this[`${color}BG`] = (...args) => this.sgr(`${color}BG`, ...args);
        });
    }

    static get SGRAttributes() {
        return SGRAttributes;
    }

    static hasSGRAttribute(name) {
        return Object.prototype.hasOwnProperty.call(SGRAttributes, name);
    }
