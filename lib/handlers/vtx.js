...
module.exports = class VTX {
    ...
    defineAudioObject(n, type, encoded) {
        return `${CSI}1;0;${n};${type};${encoded}_`;
    }

    defineAudioObjectURL(n, url) {
        return this.defineAudioObject(n, 1, hex3encode(url));
    }
