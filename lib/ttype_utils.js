...
exports.normalizedTermType = (ttype) => {
    //  An exact capability entry always wins over the heuristics
    //  below: 'ansi-bbs-256color' is an entry of its own, not an
    //  xterm variant that happens to end in '-256color'.
    if (Object.prototype.hasOwnProperty.call(Capabilities, ttype)) {
        return ttype;
    }
