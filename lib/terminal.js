...
module.exports = class Terminal {
    ...
    hyperlink(url, text='') {
        ...
        this.write(capHandler ? capHandler.hyperlink(url, text) : (text || url));
        return this;
    }
    ...
    _color(...args) {
        switch (args.length) {
            case 2 :
                ...
                this.write(this._colorIndexed(args[0], args[1]));
                return this;

            case 3 :
                //  3/4-bit or 8-bit/256
                if (Terminal.AsSequence === args[1]) {
                    return this._colorIndexed(args[0], args[1]);
                }
                break;
