...
const ANSI_BBS = require('./delegates/ansi_bbs');
...
module.exports = class TerminalOutput {
    ...
    _addStandardMethods() {
        //  Methods found in the ANSI-BBS delegate
        //  can be brought over directly.
        const from = new ANSI_BBS();
        const methods = Object.getOwnPropertyNames(from);
        methods.forEach(method => {
            this[method] = (...args) => from[method](...args);
        });
    }
